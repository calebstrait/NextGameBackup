...
def games_output():
    ...
    return render_template("output.html", pic = recs.covers[0], title = recs.names[0], genres = recs.genres[0], glink = recs.glink[0], amazn = recs.amazn[0], summary = recs.summary[0], found_dict = found_dict)
